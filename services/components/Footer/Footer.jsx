    ...
    <footer className="footer">
      <Container>
        <Row>
          ...
          <div className="logo">
          <img src={logo} alt="" />
          <p>We are committed to creating unforgettable travel experiences.".</p>
          </div>
...
<ListGroup className='footer__quick-links'>
    ...
    <p className='mb-0'>SafarShuru123@gmail.com</p>
      </ListGroupItem>
      <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
    <h6 className='mb-0 d-flex align-items-center gap-2'>
    ...
    <p className='mb-0'>+91-123456789</p>
          ...
          <p className='copyright'>
            Copyright {year}, @SafarShuru123. All Rights Reserved </p>
          </Col>
        </Row>
      </Container>
    </footer>
